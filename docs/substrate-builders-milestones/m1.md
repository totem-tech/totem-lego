...
For this Milestone the technical tasks are to develop and set the correct weighting mechanism for each of Totem’s public APIs in each of the Totem Pallets. 
